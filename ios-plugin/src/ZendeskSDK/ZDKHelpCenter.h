 ...
 */
+ (void) setConversationsBarButtonImage:(NSString *)name __deprecated_msg("Deprecated as of 1.10.1.1, use ZDKHelpCenterConversationsUIDelegate instead.");
 ...
 */
+ (void) setNavBarConversationsUIType:(ZDKNavBarConversationsUIType)uiType __deprecated_msg("Deprecated as of 1.10.1.1, use ZDKHelpCenterConversationsUIDelegate instead.");
